...
This directory contains Scripts for performing NER (Named Entity Recognition) using spaCy with historical magazine text.  ________________________________________________________________________________________________________________________________________________________________________________________
